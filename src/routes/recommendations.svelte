...
<section class="container mh-container">
  ...
  <p>
    ...
    The best code editor hands down. I use
  ...
  <p>
    <b>Qwant:</b>
    If you disagree with the data collection practices by Google, there is a good search engine
    alternative called
    ...
    , because Qwant is based in France and therefore has to conform to European GDPR data
    regulations.
  </p>

  <p>
    <b>Gravit Designer:</b>
    Free and cross-OS graphics tool with an intuitive interface.
  ...
  <p>
    ...
    pull-ups in a percentage. No matter your fitness level, the personalized training program will
    motivate you to get in great shape and reach the next level.
  </p>
